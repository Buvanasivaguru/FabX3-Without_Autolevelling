...
#define STRING_VERSION_CONFIG_H __DATE__ "3/8/16 " __TIME__ // build date and time/
#define STRING_CONFIG_H_AUTHOR "(Buvan_Redd, FabX3_MKS_Gen)" // Who made the changes.*******************************************************
